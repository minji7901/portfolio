...
const AboutSection = () => {
  return (
    <section id="about" className="pb-[300px]">
            ...
            <li className="flex pb-10 gap-20">
              ...
              <div>
                ...
                <p className="pt-3 text-base-secondary leading-7">
                  ...
                  개발을 담당하였습니다. <br />
                  그리고 퍼블리셔 프리랜서 프로젝트를 수행하여, 계약된 일정보다
                  한 달 빠르게 작업을 마무리한 경험이 있습니다.
                  <br />
            ...
            <li className="flex pb-10 gap-20">
              ...
              <div>
                ...
                <p className="pt-3 text-base-secondary leading-7">
                  ...
                  업무를 수행했습니다. <br />
                  사수와의 교대 근무를 통해 프로젝트를 안정적으로 운영했고,{" "}
                  <br />
                  일정 내 배포를 목표로 이슈 대응과 작업 관리를 경험했습니다.{" "}
                  <br /> 이 시기를 통해 협업 환경에서의 책임감과 기본기를 다질
                  수 있었습니다.
                </p>
              </div>
            </li>
